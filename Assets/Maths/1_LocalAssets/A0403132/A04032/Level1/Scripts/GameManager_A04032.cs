...
[System.Serializable]
public class QuestionSpriteItems_A04032
{
    public Sprite[] Questionsprite;
}

public class GameManager_A04032 : MonoBehaviour, IOAKSGame
{
    ...
    public QuestionSpriteItems_A04032[] QuestionItems;
    ...
    public void SetTutorial(GameInputData gameInputData)
    {
        ...
        Invoke("CallIntro2", Sound_Intro1[VOLanguage].clip.length + 1.25f);
    }
    ...
    public void BtnAct_OkTut()
    {
        ...
        //Tut_Items.transform.GetChild(3).GetComponent<PopTweenCustom>().Invoke("StopAnim", LengthDelay + LengthDelay2 + 0.25f);
        ...
        for (int i = 0; i < QuestionObjs.Length; i++)
        {
            ...
            else
            {
                if (i == 0)
                {
                    ...
                    QuestionObjs[i].sprite = QuestionItems[CurrentQuestion].Questionsprite[_ixx];
                }
                else
                if (i == 1)
                {
                    int _iyy = ItemsOrder[i];
                    QuestionObjs[i].sprite = QuestionItems[CurrentQuestion].Questionsprite[_iyy];
                }
                else
                if (i == 2)
                {
                    int _izz = ItemsOrder[i];
                    QuestionObjs[i].sprite = QuestionItems[CurrentQuestion].Questionsprite[_izz];
                }
                else
                if (i == 3)
                {
                    int _iww = ItemsOrder[i];
                    QuestionObjs[i].sprite = QuestionItems[CurrentQuestion].Questionsprite[_iww];
                }
            }
    ...
    public QVO_AudioSource_A04032 Sound_QVO;
    public AVO_AudioSource_A04032 Sound_AVO;
    ...
    #endregion
    [System.Serializable]
    public class AVO_AudioSource_A04032
    {
    ...
    [System.Serializable]
    public class QVO_AudioSource_A04032
    {
