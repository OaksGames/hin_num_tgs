...
public class GameManager_B03031 : MonoBehaviour, IOAKSGame
{
            ...
            case 0:
                switch (_Ai)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        PlayAudio(Sound_A62_Items, _delay);
                        ClipLength = Sound_A62_Items[VOLanguage].clip.length;
                        break;
                    case 2:
                        PlayAudio(Sound_A63_Items, _delay);
                        ClipLength = Sound_A63_Items[VOLanguage].clip.length;
                        break;
                    case 3:
                        PlayAudio(Sound_A64_Items, _delay);
                        ClipLength = Sound_A64_Items[VOLanguage].clip.length;
                        break;
                    case 4:
                        PlayAudio(Sound_A65_Items, _delay);
                        ClipLength = Sound_A65_Items[VOLanguage].clip.length;
                        break;
                    case 5:
                        PlayAudio(Sound_A66_Items, _delay);
                        ClipLength = Sound_A66_Items[VOLanguage].clip.length;
                        break;
                    case 6:
                        PlayAudio(Sound_A67_Items, _delay);
                        ClipLength = Sound_A67_Items[VOLanguage].clip.length;
                        break;
                    case 7:
                        PlayAudio(Sound_A68_Items, _delay);
                        ClipLength = Sound_A68_Items[VOLanguage].clip.length;
                        break;
                    case 8:
                        PlayAudio(Sound_A69_Items, _delay);
                        ClipLength = Sound_A69_Items[VOLanguage].clip.length;
                        break;
                    case 9:
                        PlayAudio(Sound_A70_Items, _delay);
                        ClipLength = Sound_A70_Items[VOLanguage].clip.length;
                        break;
    ...
    public AudioSource[] Sound_A62_Items;
    public AudioSource[] Sound_A63_Items;
    public AudioSource[] Sound_A64_Items;
    public AudioSource[] Sound_A65_Items;
    public AudioSource[] Sound_A66_Items;
    public AudioSource[] Sound_A67_Items;
    public AudioSource[] Sound_A68_Items;
    public AudioSource[] Sound_A69_Items;
    public AudioSource[] Sound_A70_Items;
