...
public class GameManager_B03033 : MonoBehaviour, IOAKSGame
{
            ...
            case 0:
                switch (_Ai)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        PlayAudio(Sound_A72_Items, _delay);
                        ClipLength = Sound_A72_Items[VOLanguage].clip.length;
                        break;
                    case 2:
                        PlayAudio(Sound_A73_Items, _delay);
                        ClipLength = Sound_A73_Items[VOLanguage].clip.length;
                        break;
                    case 3:
                        PlayAudio(Sound_A74_Items, _delay);
                        ClipLength = Sound_A74_Items[VOLanguage].clip.length;
                        break;
                    case 4:
                        PlayAudio(Sound_A75_Items, _delay);
                        ClipLength = Sound_A75_Items[VOLanguage].clip.length;
                        break;
                    case 5:
                        PlayAudio(Sound_A76_Items, _delay);
                        ClipLength = Sound_A76_Items[VOLanguage].clip.length;
                        break;
                    case 6:
                        PlayAudio(Sound_A77_Items, _delay);
                        ClipLength = Sound_A77_Items[VOLanguage].clip.length;
                        break;
                    case 7:
                        PlayAudio(Sound_A78_Items, _delay);
                        ClipLength = Sound_A78_Items[VOLanguage].clip.length;
                        break;
                    case 8:
                        PlayAudio(Sound_A79_Items, _delay);
                        ClipLength = Sound_A79_Items[VOLanguage].clip.length;
                        break;
                    case 9:
                        PlayAudio(Sound_A80_Items, _delay);
                        ClipLength = Sound_A80_Items[VOLanguage].clip.length;
                        break;
    ...
    public AudioSource[] Sound_A72_Items;
    public AudioSource[] Sound_A73_Items;
    public AudioSource[] Sound_A74_Items;
    public AudioSource[] Sound_A75_Items;
    public AudioSource[] Sound_A76_Items;
    public AudioSource[] Sound_A77_Items;
    public AudioSource[] Sound_A78_Items;
    public AudioSource[] Sound_A79_Items;
    public AudioSource[] Sound_A80_Items;
