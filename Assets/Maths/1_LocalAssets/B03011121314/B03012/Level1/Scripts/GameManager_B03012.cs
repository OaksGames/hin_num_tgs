...
public class GameManager_B03012 : MonoBehaviour, IOAKSGame
{
   ...
   /* bool Init;
    ...
    {
        TutNumberObjs[5].gameObject.GetComponent<Image>().raycastTarget = true;
    }
    ...
    public void Selected_TutAnswer()
    {
        ...
        TutorialObj.GetComponent<Animator>().enabled = false;
        TutNumberObjs[5].transform.GetComponent<Button>().enabled = false;
        TutBtn_Okay.gameObject.SetActive(true);
        TutNumberObjs[5].transform.GetComponent<PopTweenCustom>().StartAnim();
    ...
    public void BtnAct_OkTut()
    {
        ...
        TutNumberObjs[5].transform.GetComponent<PopTweenCustom>().Invoke("StopAnim", LengthDelay + 1f);
