...
public class GameManager_B03011 : MonoBehaviour, IOAKSGame
{
            ...
            case 0:
                switch (_Ai)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        PlayAudio(Sound_A22_Items, _delay);
                        ClipLength = Sound_A22_Items[VOLanguage].clip.length;
                        break;
                    case 2:
                        PlayAudio(Sound_A23_Items, _delay);
                        ClipLength = Sound_A23_Items[VOLanguage].clip.length;
                        break;
                    case 3:
                        PlayAudio(Sound_A24_Items, _delay);
                        ClipLength = Sound_A24_Items[VOLanguage].clip.length;
                        break;
                    case 4:
                        PlayAudio(Sound_A25_Items, _delay);
                        ClipLength = Sound_A25_Items[VOLanguage].clip.length;
                        break;
                    case 5:
                        PlayAudio(Sound_A26_Items, _delay);
                        ClipLength = Sound_A26_Items[VOLanguage].clip.length;
                        break;
                    case 6:
                        PlayAudio(Sound_A27_Items, _delay);
                        ClipLength = Sound_A27_Items[VOLanguage].clip.length;
                        break;
                    case 7:
                        PlayAudio(Sound_A28_Items, _delay);
                        ClipLength = Sound_A28_Items[VOLanguage].clip.length;
                        break;
                    case 8:
                        PlayAudio(Sound_A29_Items, _delay);
                        ClipLength = Sound_A29_Items[VOLanguage].clip.length;
                        break;
                    case 9:
                        PlayAudio(Sound_A30_Items, _delay);
                        ClipLength = Sound_A22_Items[VOLanguage].clip.length;
                        break;
    ...
    public AudioSource[] Sound_A22_Items;
    public AudioSource[] Sound_A23_Items;
    public AudioSource[] Sound_A24_Items;
    public AudioSource[] Sound_A25_Items;
    public AudioSource[] Sound_A26_Items;
    public AudioSource[] Sound_A27_Items;
    public AudioSource[] Sound_A28_Items;
    public AudioSource[] Sound_A29_Items;
    public AudioSource[] Sound_A30_Items;
