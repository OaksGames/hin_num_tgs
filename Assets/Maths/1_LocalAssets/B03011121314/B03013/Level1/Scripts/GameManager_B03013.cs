...
public class GameManager_B03013 : MonoBehaviour, IOAKSGame
{
            ...
            case 0:
                switch (_Ai)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        PlayAudio(Sound_A32_Items, _delay);
                        ClipLength = Sound_A32_Items[VOLanguage].clip.length;
                        break;
                    case 2:
                        PlayAudio(Sound_A33_Items, _delay);
                        ClipLength = Sound_A33_Items[VOLanguage].clip.length;
                        break;
                    case 3:
                        PlayAudio(Sound_A34_Items, _delay);
                        ClipLength = Sound_A34_Items[VOLanguage].clip.length;
                        break;
                    case 4:
                        PlayAudio(Sound_A35_Items, _delay);
                        ClipLength = Sound_A35_Items[VOLanguage].clip.length;
                        break;
                    case 5:
                        PlayAudio(Sound_A36_Items, _delay);
                        ClipLength = Sound_A36_Items[VOLanguage].clip.length;
                        break;
                    case 6:
                        PlayAudio(Sound_A37_Items, _delay);
                        ClipLength = Sound_A37_Items[VOLanguage].clip.length;
                        break;
                    case 7:
                        PlayAudio(Sound_A38_Items, _delay);
                        ClipLength = Sound_A38_Items[VOLanguage].clip.length;
                        break;
                    case 8:
                        PlayAudio(Sound_A39_Items, _delay);
                        ClipLength = Sound_A39_Items[VOLanguage].clip.length;
                        break;
                    case 9:
                        PlayAudio(Sound_A40_Items, _delay);
                        ClipLength = Sound_A40_Items[VOLanguage].clip.length;
                        break;
    ...
    public AudioSource[] Sound_A32_Items;
    public AudioSource[] Sound_A33_Items;
    public AudioSource[] Sound_A34_Items;
    public AudioSource[] Sound_A35_Items;
    public AudioSource[] Sound_A36_Items;
    public AudioSource[] Sound_A37_Items;
    public AudioSource[] Sound_A38_Items;
    public AudioSource[] Sound_A39_Items;
    public AudioSource[] Sound_A40_Items;
