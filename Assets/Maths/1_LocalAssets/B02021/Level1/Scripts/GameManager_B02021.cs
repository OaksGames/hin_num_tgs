...
public class GameManager_B02021 : MonoBehaviour, IOAKSGame
{
    ...
    public void SetTutorial(GameInputData gameInputData)
    {
        ...
        PlayAudio(Sound_Intro2, Sound_Intro1[VOLanguage].clip.length + 0.2f);
        PlayAudio(Sound_Intro3, Sound_Intro2[VOLanguage].clip.length + 3f);
        ...
        Invoke("CallIntro4",  + Sound_Intro3[VOLanguage].clip.length + 9f);
    ...
    public void CallIntro4()
    {
        ...
        Invoke("EnableTutNoTRaycatTarget", Sound_Intro4[VOLanguage].clip.length + 0.1f);
    ...
    public void Selected_TutAnswer()
    {
        ...
        iTween.MoveTo(SelectedTut_Option.gameObject, iTween.Hash("x", 420, "time", 0.3f, "delay", CurrentQuestion * 0.1f, "islocal", true, "easetype", iTween.EaseType.linear));
    ...
    public void BtnAct_OkTut()
    {
        ...
        PlayAudio(Sound_CorrectAnswer, LengthDelay + Sound_Intro6[VOLanguage].clip.length + 0.5f);
        ...
        Invoke("SetGamePlay", LengthDelay +  Sound_Intro6[VOLanguage].clip.length + 3f);
    }
    #endregion
    ...
    public void GenerateLevel()
    {
        ...
        for (int i = 0; i < AnswerObjs.Length; i++)
        {
            if (RandAnsrIndex == i)
            {
                AnswerObjs[i].GetComponent<Text>().text = "" + CurrentQuestion * 5;
            ...
            else
            {
                if (i == 0)
                {
                    ...
                    AnswerObjs[i].GetComponent<Text>().text = "" + _ixx * 5;
                ...
                if (i == 1)
                {
                    ...
                    AnswerObjs[i].GetComponent<Text>().text = "" + _iyy * 5;
                ...
                if (i == 2)
                {
                    ...
                    AnswerObjs[i].GetComponent<Text>().text = "" + _izz * 5;
                ...
                if (i == 3)
                {
                    ...
                    AnswerObjs[i].GetComponent<Text>().text = "" + _iqq * 5;
    ...
    {
        iTween.MoveTo(SelectedOptHolder.gameObject, iTween.Hash("x", 420, "time", 0.3f, "delay", 0, "islocal", true, "easetype", iTween.EaseType.linear));
        StopRepetedAudio();
        UserAnsr = _Ansrindex;
    ...
    {
        AnswerDisplay.GetComponent<Text>().text = "" + AnswerObjs[CorrectAnsrIndex].GetComponent<Text>().text;
    }
    ...
    public void BtnAct_Ok()
    {
        ...
        if (CorrectAnsrIndex == UserAnsr)
        {
            ...
            float LengthDelay = PlayAppreciationVoiceOver(Sound_Btn_Ok_Click.clip.length) + Sound_Btn_Ok_Click.clip.length+0.25f;
            ...
            iTween.MoveTo(OptionsHolder.gameObject, iTween.Hash("y", -250, "time", 0.25f, "delay", LengthDelay + LengthDelay2 + 2f, "easetype", iTween.EaseType.easeOutElastic));

            iTween.MoveTo(SelectedOptHolder.gameObject, iTween.Hash("x", 617, "time", 0.25f, "delay", LengthDelay + LengthDelay2 + 2f, "islocal", true, "easetype", iTween.EaseType.linear));//CS
        ...
        else
        {
            ...
            {
                Invoke("Answerdisplay", 0.5f);
                float LengthDelay = PlayAnswerVoiceOver(CurrentQuestion-1, 1f);
                iTween.MoveTo(SelectedOptHolder.gameObject, iTween.Hash("x", 420, "time", 0.3f, "delay", 0.5f, "islocal", true, "easetype", iTween.EaseType.linear));
                Invoke("HighlightOptions", 0.5f);
                iTween.MoveTo(SelectedOptHolder.gameObject, iTween.Hash("x", 617, "time", 0.3f, "delay",3f, "islocal", true, "easetype", iTween.EaseType.linear));
                for (int i = 0; i < AnswerObjs.Length; i++)
                {
                    if (AnswerObjs[i] != null)
                    {
    ...
    public QO_AudioSource_B02021[] Sound_QVO;
    public AO_AudioSource_B02021[] Sound_AVO;
...
[System.Serializable]
public class AO_AudioSource_B02021
{
...
[System.Serializable]
public class QO_AudioSource_B02021
{
