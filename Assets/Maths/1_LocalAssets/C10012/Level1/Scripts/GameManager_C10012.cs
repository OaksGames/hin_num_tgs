...
public class GameManager_C10012 : MonoBehaviour
{
    ...
    public void SetTutorial()
    {
        ...
        {
            iTween.ScaleFrom(Tut_Items.transform.GetChild(i).gameObject, iTween.Hash("Scale", Vector3.zero, "time", 0.5f, "delay", Sound_Intro1[VOLanguage].clip.length + 3f + _delay, "easetype", iTween.EaseType.easeOutElastic));
            StartCoroutine(PlayAudioAtOneShot(Sound_Ting, Sound_Intro1[VOLanguage].clip.length + 3f + _delay));
            _delay += 0.1f;
        }
        iTween.MoveTo(Tut_Sidepanel.gameObject, iTween.Hash("x", 512, "islocal", true, "time", 1f, "delay", Sound_Intro1[VOLanguage].clip.length + 2f, "easetype", iTween.EaseType.linear));

        PlayAudio(Sound_Intro2, Sound_Intro1[VOLanguage].clip.length + 2f);
        PlayAudio(Sound_Intro3, Sound_Intro1[VOLanguage].clip.length  + Sound_Intro2[VOLanguage].clip.length + 2f);
        Invoke("EnableAnimator", 2f);
        Invoke("CallIntro2", Sound_Intro3[VOLanguage].clip.length + Sound_Intro3[VOLanguage].clip.length + Sound_Intro1[VOLanguage].clip.length + Sound_Intro2[VOLanguage].clip.length + 2f);
        Invoke("CallIntro3",  Sound_Intro3[VOLanguage].clip.length + Sound_Intro1[VOLanguage].clip.length + Sound_Intro2[VOLanguage].clip.length + 10f);
    }
    ...
    public void BtnAct_OkTut()
    {
        ...
        PlayAppreciationVoiceOver(Sound_Intro6[VOLanguage].clip.length+1f);
        PlayAudio(Sound_CorrectAnswer, Sound_Intro6[VOLanguage].clip.length + 1.5f);
        Tween_TickMark.myScript.Invoke("Tween_In", Sound_Intro6[VOLanguage].clip.length + 1.5f);
        Tut_Items.transform.GetChild(1).GetComponent<PopTweenCustom>().Invoke("StopAnim", Sound_Intro6[VOLanguage].clip.length + 1f);
        iTween.MoveTo(Tut_Sidepanel.gameObject, iTween.Hash("x", 5000, "time", 1f, "delay", 5.5f, "easetype", iTween.EaseType.linear));
        PlayAudio(Sound_Intro7, Sound_Intro6[VOLanguage].clip.length + 3f);
        Invoke("SetGamePlay", Sound_Intro6[VOLanguage].clip.length + Sound_Intro7[VOLanguage].clip.length + 3.5f);
    }
    #endregion
    ...
    public void GenerateLevel()
    {
        ...
        for (int i = 0; i < AnswerObjs.Length; i++)
        {
            if (RandAnsrIndex == i)
            {
                ...
                { AnswerObjs[i].GetComponent<Text>().text = "0" + CurrentQuestion + ":30"; }
                else
                { AnswerObjs[i].GetComponent<Text>().text = "" + CurrentQuestion + ":30"; }
            ...
            else
            {
                if (i == 0)
                {
                    ...
                    if (_ixx <= 9)
                    { AnswerObjs[i].GetComponent<Text>().text = "0" + _ixx + ":30"; }
                    else
                    { AnswerObjs[i].GetComponent<Text>().text = "" + _ixx + ":30"; }
                ...
                if (i == 1)
                {
                    ...
                    if (_iyy <= 9)
                    { AnswerObjs[i].GetComponent<Text>().text = "0" + _iyy + ":30"; }
                    else
                    { AnswerObjs[i].GetComponent<Text>().text = "" + _iyy + ":30"; }
                ...
                if (i == 2)
                {
                    ...
                    if (_izz <= 9)
                    { AnswerObjs[i].GetComponent<Text>().text = "0" + _izz + ":30"; }
                    else
                    { AnswerObjs[i].GetComponent<Text>().text = "" + _izz + ":30"; }
        ...
        for (int i = 0; i < AnswerObjs.Length; i++)
        {
            iTween.ScaleFrom(AnswerObjs[i].gameObject, iTween.Hash("Scale", Vector3.zero, "time", 1f,"islocal", true, "delay", QVOLength + _delay1, "easetype", iTween.EaseType.easeOutElastic));
    ...
    {
         Is_CanClick = false;
        iTween.RotateTo(Obj_Hours.gameObject, iTween.Hash("z", ((-30 * _TimeInput)-15), "time", 1f, "delay", 0, "easetype", iTween.EaseType.easeOutCirc));
