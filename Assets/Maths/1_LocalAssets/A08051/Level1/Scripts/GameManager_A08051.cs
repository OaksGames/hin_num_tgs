...
[System.Serializable]
public class QuestionSpriteItems_A08051
{
    public Sprite[] Questionsprite;
}


public class GameManager_A08051 : MonoBehaviour, IOAKSGame
{
    ...
    public QuestionSpriteItems_A08051[] QuestionItems;
    ...
    public void CallIntro2()
    {
        ...
        Invoke("EnableTutRaycast", Sound_Intro2[VOLanguage].clip.length + 0.1f);
    }
    ...
    public void BtnAct_OkTut()
    {
        ...
        float LengthDelay2 = PlayAnswerVoiceOver(0, LengthDelay+0.2f);
    ...
    public void GenerateLevel()
    {
        ...
        int[] randomYDir = new int[2] { -250, -250 };
        int[] randomXDir = new int[2] { -300, 300};

        int x= randomXDir[Random.Range(0, randomXDir.Length)];
        int y = randomYDir[Random.Range(0, randomYDir.Length)];
        pos1 = new Vector3(x, y, 0);
        QuestionObjs[1].GetComponent<RectTransform>().localPosition = pos1;
        
        float _delay = 0;
        for (int i = 0; i < QuestionObjs.Length; i++)
        {
            iTween.ScaleFrom(QuestionObjs[i].gameObject, iTween.Hash("Scale", Vector3.zero, "time", 0.5f, "delay", _delay, "easetype", iTween.EaseType.easeOutElastic));
            StartCoroutine(PlayAudioAtOneShot(Sound_Ting, _delay));
            _delay += 0.1f;
        }
    ...
    public QVO_AudioSource_A08051[] Sound_QVO;
    public AVO_AudioSource_A08051[] Sound_AVO;
 ...
 public void StopRepetedAudio()
    ...
    #endregion
    [System.Serializable]
    public class AVO_AudioSource_A08051
    {
    ...
    [System.Serializable]
    public class QVO_AudioSource_A08051
    {
