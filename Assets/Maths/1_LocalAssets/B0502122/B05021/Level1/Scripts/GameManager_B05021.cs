...
public class GameManager_B05021 : MonoBehaviour, IOAKSGame
{
    ...
    public GameObject QtnObjPrefab;
    public GameObject QuestionObj;
    public QuestionObjects[] QtnObjs;
    ...
    public void SetTutorial(GameInputData gameInputData)
    {
        ...
        iTween.ScaleFrom(Tut_Items.gameObject, iTween.Hash("Scale", Vector3.zero, "time", 1f, "delay", _delay, "easetype", iTween.EaseType.easeOutElastic));
    ...
    {
        Tut_Items2.transform.GetChild(1).GetComponent<Image>().raycastTarget = true;
    }
    public void CallIntro2()
    {
        StopAudio(Sound_Intro1);
        PlayAudio(Sound_Intro2, 0);
        PlayAudio(Sound_Intro3, Sound_Intro2[VOLanguage].clip.length+0.2f);
        Invoke("CallIntro4", Sound_Intro3[VOLanguage].clip.length + 4f);
    ...
    public void CallIntro4()
    {
        ...
        Invoke("EnableTutRaycast", Sound_Intro4[VOLanguage].clip.length + 0.1f);
    }
    ...
    public void Selected_TutAnswer()
    {
        ...
        Tut_Items2.transform.GetChild(1).GetComponent<Image>().raycastTarget = false;
        Tut_Items2.transform.GetChild(1).GetComponent<PopTweenCustom>().StartAnim();
    ...
    {
        Tut_Items2.transform.GetChild(1).GetComponent<PopTweenCustom>().StopAnim();
    }
    public void BtnAct_OkTut()
    {
        ...
        float LengthDelay = PlayAppreciationVoiceOver(0.4f);
        //float LengthDelay2 = PlayAnswerVoiceOver(14, LengthDelay);
     
        PlayAudio(Sound_CorrectAnswer, LengthDelay + 0.5f);
        Invoke("stopanim", LengthDelay  + 0.6f);
        Tween_TickMark.myScript.Invoke("Tween_In", LengthDelay + 0.5f);
        
        PlayAudio(Sound_Intro6, LengthDelay+ 2f);

        Invoke("SetGamePlay", LengthDelay + Sound_Intro6[VOLanguage].clip.length + 2f);
    }
    #endregion
    ...
    public QVO_AudioSource_B05021 Sound_QVO;
    public AVO_AudioSource_B05021 Sound_AVO;
    ...
    [System.Serializable]
    public class AVO_AudioSource_B05021
    {
    ...
    [System.Serializable]
    public class QVO_AudioSource_B05021
    {
