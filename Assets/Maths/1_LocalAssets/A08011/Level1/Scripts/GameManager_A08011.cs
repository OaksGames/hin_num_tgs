...
[System.Serializable]
public class QuestionSpriteItems_A08031
{
...
public class GameManager_A08011 : MonoBehaviour, IOAKSGame
{
    ...
    // this variable carries the increment value of the progress bar after every question
    /*public float AddValueInProgress = 0;
    public float PValueAdd;
    public GameInputData gameInputData;
    // initialize a list of question keys
    ...
    /*void Start2(GameInputData gameInputData)
    {
        if (Is_Tutorial)
        {
            SetTutorial();
            Is_NeedRandomizedQuestions = gameInputData.IsRandom;
            NoOfQuestionsToAsk = gameInputData.Mechanics.Count;
        }
        else
        {
            SetGamePlay();
    ...
    public void CallIntro2()
    {
        ...
        Tut_Items.transform.GetChild(2).gameObject.GetComponent<Image>().raycastTarget = true;
    }
    ...
    public void BtnAct_OkTut()
    {
        ...
        Tut_Items.transform.GetChild(2).GetComponent<PopTweenCustom>().Invoke("StopAnim", LengthDelay + LengthDelay2 + 1f);
    ...
    public void SetGamePlay()
    {
        ...
        /* //Create a list of Id's of question being posed in the game
        for (int ict = 0; ict < NoOfQuestionsToAsk; ict++)
        {
            string AddKey = "" + this.gameInputData.Key + "_Q" + (QuestionOrderList[ict]).ToString();
            QuesKeys.Add(AddKey);
        }
        // forward the list of the questions Id's being posed to the framework to initialize the QuestionResults list
        GameFrameworkInterface.Instance.ReplaceQuestionKeys(QuesKeys);*/
    ...
    public void GenerateLevel()
    {
        ...
        for (int i = 0; i < CurrentItems.Length; i++)
        {
            if (QuestionsHolder[CurrentItem].transform.GetChild(i).gameObject.name.Contains("Item"))
            {
                CurrentItems[i] = QuestionsHolder[CurrentItem].transform.GetChild(i).gameObject;
            }
        }
    ...
    public QVO_AudioSource_A08011[] Sound_QVO;
    public AVO_AudioSource_A08011[] Sound_AVO;
    ...
    [System.Serializable]
    public class AVO_AudioSource_A08011
    {
    ...
    [System.Serializable]
    public class QVO_AudioSource_A08011
    {
