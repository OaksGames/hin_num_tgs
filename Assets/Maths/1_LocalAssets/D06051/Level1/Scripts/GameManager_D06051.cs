...
public class GameManager_D06051 : MonoBehaviour, IOAKSGame
{
    public bool FrameworkOff = false;
    public bool Testing = false;

    public static GameManager_D06051 Instance;
    ...
    public void BtnAct_OkTut()
    {
        ...
        PlayAudio(Sound_Intro7, LengthDelay+0.2f);
        ...
        PlayAudio(Sound_Intro8, LengthDelay + Sound_Intro7[VOLanguage].clip.length+0.5f);
    ...
    public IEnumerator ShovelTapAct()
    {
        ...
        if (_tempgemcount < CurrentQuestion)
        {
            ...
            if (_tempgemcount == CurrentQuestion)
            {
                ...
                _tempQopt = 1;
                StartCoroutine("SetAnswerOptions", 1);
                iTween.MoveTo(SidePanel.gameObject, iTween.Hash("x", 512, "islocal", true, "time", 0f, "delay", 1f, "easetype", iTween.EaseType.easeOutElastic));
    ...
    public QVO_AudioSource_D06051 Sound_QVO1;
    public QVO_AudioSource_D06051 Sound_QVO2;
    public QVO_AudioSource_D06051 Sound_QVO3;

    public AVO_AudioSource_D06051 Sound_AVO1;
    public AVO_AudioSource_D06051 Sound_AVO2;
    public AVO_AudioSource_D06051 Sound_AVO3;
    ...
    [System.Serializable]
    public class AVO_AudioSource_D06051
    {
    ...
    [System.Serializable]
    public class QVO_AudioSource_D06051
    {
