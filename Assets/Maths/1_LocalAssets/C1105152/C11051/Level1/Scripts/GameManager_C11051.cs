...
public class GameManager_C11051 : MonoBehaviour, IOAKSGame
{
   ...
   /* bool Init;
    ...
    public void Tutobjon()
    {
        ...
        Invoke("EnableTutNoTRaycatTarget", +3.5f);
    }
    ...
    public void BtnAct_OkTut()
    {
        ...
        float LengthDelay2 = PlayAnswerVoiceOver(0, LengthDelay+0.5f);
        ...
        PlayAudio(Sound_Intro4, LengthDelay + LengthDelay2 + 1.25f);

        Invoke("SetGamePlay", LengthDelay + LengthDelay2 + 5);
    }
