...
public class GameManager_B03043 : MonoBehaviour, IOAKSGame
{
            ...
            case 0:
                switch (_Ai)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        PlayAudio(Sound_A92_Items, _delay);
                        ClipLength = Sound_A92_Items[VOLanguage].clip.length;
                        break;
                    case 2:
                        PlayAudio(Sound_A93_Items, _delay);
                        ClipLength = Sound_A93_Items[VOLanguage].clip.length;
                        break;
                    case 3:
                        PlayAudio(Sound_A94_Items, _delay);
                        ClipLength = Sound_A94_Items[VOLanguage].clip.length;
                        break;
                    case 4:
                        PlayAudio(Sound_A95_Items, _delay);
                        ClipLength = Sound_A95_Items[VOLanguage].clip.length;
                        break;
                    case 5:
                        PlayAudio(Sound_A96_Items, _delay);
                        ClipLength = Sound_A96_Items[VOLanguage].clip.length;
                        break;
                    case 6:
                        PlayAudio(Sound_A97_Items, _delay);
                        ClipLength = Sound_A97_Items[VOLanguage].clip.length;
                        break;
                    case 7:
                        PlayAudio(Sound_A98_Items, _delay);
                        ClipLength = Sound_A98_Items[VOLanguage].clip.length;
                        break;
                    case 8:
                        PlayAudio(Sound_A99_Items, _delay);
                        ClipLength = Sound_A99_Items[VOLanguage].clip.length;
                        break;
                    case 9:
                        PlayAudio(Sound_A100_Items, _delay);
                        ClipLength = Sound_A100_Items[VOLanguage].clip.length;
                        break;
    ...
    public AudioSource[] Sound_A92_Items;
    public AudioSource[] Sound_A93_Items;
    public AudioSource[] Sound_A94_Items;
    public AudioSource[] Sound_A95_Items;
    public AudioSource[] Sound_A96_Items;
    public AudioSource[] Sound_A97_Items;
    public AudioSource[] Sound_A98_Items;
    public AudioSource[] Sound_A99_Items;
    public AudioSource[] Sound_A100_Items;
