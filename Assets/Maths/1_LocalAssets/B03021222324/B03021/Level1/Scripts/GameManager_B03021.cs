...
public class GameManager_B03021 : MonoBehaviour, IOAKSGame
{
            ...
            case 0:
                switch (_Ai)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        PlayAudio(Sound_A42_Items, _delay);
                        ClipLength = Sound_A42_Items[VOLanguage].clip.length;
                        break;
                    case 2:
                        PlayAudio(Sound_A43_Items, _delay);
                        ClipLength = Sound_A43_Items[VOLanguage].clip.length;
                        break;
                    case 3:
                        PlayAudio(Sound_A44_Items, _delay);
                        ClipLength = Sound_A44_Items[VOLanguage].clip.length;
                        break;
                    case 4:
                        PlayAudio(Sound_A45_Items, _delay);
                        ClipLength = Sound_A45_Items[VOLanguage].clip.length;
                        break;
                    case 5:
                        PlayAudio(Sound_A46_Items, _delay);
                        ClipLength = Sound_A46_Items[VOLanguage].clip.length;
                        break;
                    case 6:
                        PlayAudio(Sound_A47_Items, _delay);
                        ClipLength = Sound_A47_Items[VOLanguage].clip.length;
                        break;
                    case 7:
                        PlayAudio(Sound_A48_Items, _delay);
                        ClipLength = Sound_A48_Items[VOLanguage].clip.length;
                        break;
                    case 8:
                        PlayAudio(Sound_A49_Items, _delay);
                        ClipLength = Sound_A49_Items[VOLanguage].clip.length;
                        break;
                    case 9:
                        PlayAudio(Sound_A50_Items, _delay);
                        ClipLength = Sound_A50_Items[VOLanguage].clip.length;
                        break;
    ...
    public AudioSource[] Sound_A42_Items;
    public AudioSource[] Sound_A43_Items;
    public AudioSource[] Sound_A44_Items;
    public AudioSource[] Sound_A45_Items;
    public AudioSource[] Sound_A46_Items;
    public AudioSource[] Sound_A47_Items;
    public AudioSource[] Sound_A48_Items;
    public AudioSource[] Sound_A49_Items;
    public AudioSource[] Sound_A50_Items;
