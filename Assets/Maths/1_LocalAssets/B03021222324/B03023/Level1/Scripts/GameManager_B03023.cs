...
public class GameManager_B03023 : MonoBehaviour, IOAKSGame
{
            ...
            case 0:
                switch (_Ai)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        PlayAudio(Sound_A52_Items, _delay);
                        ClipLength = Sound_A52_Items[VOLanguage].clip.length;
                        break;
                    case 2:
                        PlayAudio(Sound_A53_Items, _delay);
                        ClipLength = Sound_A53_Items[VOLanguage].clip.length;
                        break;
                    case 3:
                        PlayAudio(Sound_A54_Items, _delay);
                        ClipLength = Sound_A54_Items[VOLanguage].clip.length;
                        break;
                    case 4:
                        PlayAudio(Sound_A55_Items, _delay);
                        ClipLength = Sound_A55_Items[VOLanguage].clip.length;
                        break;
                    case 5:
                        PlayAudio(Sound_A56_Items, _delay);
                        ClipLength = Sound_A56_Items[VOLanguage].clip.length;
                        break;
                    case 6:
                        PlayAudio(Sound_A57_Items, _delay);
                        ClipLength = Sound_A57_Items[VOLanguage].clip.length;
                        break;
                    case 7:
                        PlayAudio(Sound_A58_Items, _delay);
                        ClipLength = Sound_A58_Items[VOLanguage].clip.length;
                        break;
                    case 8:
                        PlayAudio(Sound_A59_Items, _delay);
                        ClipLength = Sound_A59_Items[VOLanguage].clip.length;
                        break;
                    case 9:
                        PlayAudio(Sound_A60_Items, _delay);
                        ClipLength = Sound_A60_Items[VOLanguage].clip.length;
                        break;
    ...
    public AudioSource[] Sound_A52_Items;
    public AudioSource[] Sound_A53_Items;
    public AudioSource[] Sound_A54_Items;
    public AudioSource[] Sound_A55_Items;
    public AudioSource[] Sound_A56_Items;
    public AudioSource[] Sound_A57_Items;
    public AudioSource[] Sound_A58_Items;
    public AudioSource[] Sound_A59_Items;
    public AudioSource[] Sound_A60_Items;
