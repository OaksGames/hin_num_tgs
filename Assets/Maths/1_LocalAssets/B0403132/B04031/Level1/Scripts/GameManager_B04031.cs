...
public class GameManager_B04031 : MonoBehaviour, IOAKSGame
{
    ...
    public void SetTutorial(GameInputData gameInputData)
    {
        ...
        iTween.ScaleFrom(Tut_Shape.gameObject, iTween.Hash("Scale", Vector3.zero, "time", 0.5f, "delay", 0, "easetype", iTween.EaseType.easeOutElastic));
        ...
        iTween.MoveTo(Tut_Items.gameObject, iTween.Hash("y", 0, "time", 1f, "delay", Sound_Intro1[VOLanguage].clip.length + Sound_Intro2[VOLanguage].clip.length + 1, "easetype", iTween.EaseType.easeOutElastic));
    ...
    public void CallIntro3()
    {
        ...
        Invoke("EnableTutNoTRaycatTarget", Sound_Intro3[VOLanguage].clip.length  + 0.2f);
    }
    ...
    public void BtnAct_OkTut()
    {
        ...
        float LengthDelay = PlayAnswerVoiceOver(6,1f);
        PlayAppreciationVoiceOver(0.25f);
        ...
        iTween.MoveTo(Tut_Items.gameObject, iTween.Hash("y", -250, "time", 1f, "delay", 0, "easetype", iTween.EaseType.easeOutElastic));
    ...
    public void GenerateLevel()
    {
        ...
        iTween.MoveTo(DownBar.gameObject, iTween.Hash("y", 0, "time", 1f, "delay", LengthDelay, "easetype", iTween.EaseType.easeOutElastic));
    ...
    public void BtnAct_Ok()
    {
        ...
        if (CorrectAnsrIndex == UserAnsr)
        {
            ...
            StartCoroutine(SetActiveWithDelayCall(LevelsHolder, false, LengthDelay + LengthDelay2 + 2.25f));
            ...
            iTween.MoveTo(DownBar.gameObject, iTween.Hash("y", -250, "time", 1f, "delay", LengthDelay + 1.5f, "easetype", iTween.EaseType.easeOutElastic));
        ...
        else
        {
            ...
            if (WrongAnsrsCount >= 2)
            {
                ...
                StartCoroutine(SetActiveWithDelayCall(QuestionItems[CurrentQuestionOrder].transform.GetChild(0).gameObject, true, 1));
                StartCoroutine(SetActiveWithDelayCall(QuestionItems[CurrentQuestionOrder].transform.GetChild(1).gameObject, true, 1));
                iTween.ScaleFrom(QuestionItems[CurrentQuestionOrder].transform.GetChild(0).gameObject, 
                    iTween.Hash("Scale", Vector3.zero, "time", 1f, "delay", 1, "easetype", iTween.EaseType.easeOutElastic));
                iTween.ScaleFrom(QuestionItems[CurrentQuestionOrder].transform.GetChild(1).gameObject,
                    iTween.Hash("Scale", Vector3.zero, "time", 1f, "delay", 1, "easetype", iTween.EaseType.easeOutElastic));

                iTween.MoveTo(DownBar.gameObject, iTween.Hash("y", -250, "time", 0.25f, "delay", LengthDelay+2, "easetype", iTween.EaseType.easeOutElastic));
