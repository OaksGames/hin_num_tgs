...
public class GameManager_D06041 : MonoBehaviour, IOAKSGame
{
    public bool FrameworkOff = false;
    public bool Testing = false;

    public static GameManager_D06041 Instance;
    ...
    public void SetTutorial(GameInputData gameInputData)
    {
        ...
        {
            Destroy(Tut_CurrentGems[i]);
        }
        Tut_CurrentGems = new GameObject[Tut_Question];
        for (int i = 0; i < Tut_Question; i++)
        {
            Tut_CurrentGems[i] = Instantiate(Tut_GemObj.gameObject, Tut_GemHolder.transform.GetChild(i).transform.position, Quaternion.identity, Tut_GemHolder.transform);
    ...
    public void CallIntro7()
    {
        ...
        Tut_AnswerObjs[1].GetComponent<Text>().text = "" + 1;
    ...
    public IEnumerator Tut_ShovelTapAct()
    {
        ...
        if (_tempgemcount1 < Tut_Question)
        {
            ...
            if (_tempgemcount1 == Tut_Question-Tut_Reminder)
            {
    ...
    public void BtnAct_OkTut()
    {
        ...
        PlayAudio(Sound_CorrectAnswer, Sound_Intro9[VOLanguage].clip.length + LengthDelay + 1f);
        Tween_TickMark.myScript.Invoke("Tween_In", Sound_Intro9[VOLanguage].clip.length + LengthDelay + 1f);
        PlayAudio(Sound_Intro10, LengthDelay + Sound_Intro9[VOLanguage].clip.length + 0.5f);
        Tut_OptionHolder.transform.GetChild(1).gameObject.GetComponent<PopTweenCustom>().Invoke("StopAnim", LengthDelay + 2.5f);
        Invoke("SetGamePlay", LengthDelay + Sound_Intro9[VOLanguage].clip.length + Sound_Intro10[VOLanguage].clip.length + 2.5f);
    ...
    public void SetGamePlay()
    {
        ...
        GemsHolder = new GameObject[GemHolder.transform.childCount];
        for (int i = 0; i < GemHolder.transform.childCount; i++)
        {
            GemsHolder[i]= GemHolder.transform.GetChild(i).gameObject;
            GemsHolder[i].gameObject.SetActive(false);
        }
    ...
    public void GenerateLevel()
    {
        ...
        Debug.Log("---- Current Qn : " + CurrentQuestion);
        ...
        {
            CurrentGems[i] = Instantiate(GemObj.gameObject, GemHolder.transform.GetChild(i).transform.position, Quaternion.identity,GemHolder.transform);
        ...
        EachCartMaxCount =(int)CurrentQuestion/(int) CurrentQuestion2;
        Reminder = (int)CurrentQuestion % (int)CurrentQuestion2;
        Debug.Log("EachCartMaxCount : " + EachCartMaxCount+ " Reminder : "+Reminder);
        ...
        EquationHolder.transform.GetChild(2).GetComponent<Text>().text = "" + Reminder;
    ...
    public IEnumerator SetAnswerOptions(float _delay)
    {
        ...
        QuestionOrderListtemp.Remove(Reminder);
        float _delay1 = 0;
        for (int i = 0; i < AnswerObjs.Length; i++)
        {
            if (RandAnsrIndex == i)
            {
                AnswerObjs[i].GetComponent<Text>().text = "" + Reminder;
    ...
    void PlayQuestionVO()
    {
        PlayQuestionVO1(CurrentQuestionOrder);
    ...
    public void BtnAct_Ok()
    {
        ...
        if (CountOk == 0)
        {
            ...
            iTween.MoveTo(SidePanel.gameObject, iTween.Hash("x", 512, "islocal", true, "time", 1f, "delay", 0 + 1, "easetype", iTween.EaseType.easeOutElastic));
        ...
        if (CorrectAnsrIndex == UserAnsr)
        {
            ...
            iTween.ScaleFrom(EquationHolder.transform.GetChild(2).gameObject, iTween.Hash("scale", Vector3.zero, "time", 0.5f, "delay", 0, "easetype", iTween.EaseType.easeOutElastic));
                ...
                float LengthDelay2 = PlayAnswerVoiceOver1(Reminder-1, LengthDelay + 0.5f);
        ...
        else
        {
            ...
            {
                LengthDelay = PlayAnswerVoiceOver1(Reminder-1, 1f);
                //EquationHolder.transform.GetChild(2).gameObject.SetActive(true);
                iTween.ScaleFrom(EquationHolder.transform.GetChild(2).gameObject, iTween.Hash("scale", Vector3.zero, "time", 0.5f, "delay", 0, "easetype", iTween.EaseType.easeOutElastic));
    ...
    public IEnumerator ShovelTapAct()
    {
        ...
        {
            iTween.MoveTo(CurrentGems[_tempgemcount].gameObject, iTween.Hash("position", GemSlots[_slotCount].transform.GetChild(1).position, "time", 0.25f, "delay", 0, "easetype", iTween.EaseType.linear));
            ...
            if (_tempgemcount == (CurrentQuestion-Reminder))
            {
                StopRepetedAudio();
                CancelInvoke("RepeatQVOAftertChoosingOption");
                ...
                Is_OkButtonPressed = false;
                Invoke("PlayQuestionVO3", 1.2f);

                _tempQopt = CurrentQuestion;
                StartCoroutine("SetAnswerOptions", 0.7f);
    ...
    public QVO_AudioSource_D06041 Sound_QVO1;
    public QVO_AudioSource_D06041 Sound_QVO2;
    public QVO_AudioSource_D06041 Sound_QVO3;
   
    public AVO_AudioSource_D06041 Sound_AVO1;
    ...
    [System.Serializable]
    public class AVO_AudioSource_D06041
    {
    ...
    [System.Serializable]
    public class QVO_AudioSource_D06041
    {
