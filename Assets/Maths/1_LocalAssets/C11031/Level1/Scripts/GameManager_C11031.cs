...
[System.Serializable]
public class QuestionSpriteItems_C11031
{
    public Sprite[] QuestonSprites;
}

public class GameManager_C11031 : MonoBehaviour
{
    ...
    public bool Is_RandomQtnOrder1;
    ...
    public void SetTutorial()
    {
        ...
        PlayAudio(Sound_Intro1, 2.01f);
        Invoke("Tut_ItemsCall",Sound_Intro1[VOLanguage].clip.length);
        Invoke("Tut_ItemsCall1",Sound_Intro1[VOLanguage].clip.length+2f);
        PlayAudio(Sound_Intro2, Sound_Intro1[VOLanguage].clip.length +2f);
        PlayAudio(Sound_Intro3, Sound_Intro2[VOLanguage].clip.length + 14f);
        Invoke("TutorialObj12", Sound_Intro3[VOLanguage].clip.length + 14.5f);
        Invoke("CallIntro4", Sound_Intro3[VOLanguage].clip.length+24f);
        Invoke("EnableAnimator", 3f);
        Invoke("EnableTutNoTRaycatTarget", 30f);
    }
    ...
    {
        TutorialObj2.transform.GetChild(1).GetComponent<Image>().raycastTarget = true;
    }
 public void Tut_ItemsCall()
    ...
    public void Selected_TutAnswer()
    {
        ...
        TutorialObj2.transform.GetChild(1).GetComponent<Image>().raycastTarget = false;
        TutorialObj2.transform.GetChild(1).GetComponent<PopTweenCustom>().StartAnim();
        StopRepetedAudio();
    ...
    public void BtnAct_OkTut()
    {
        ...
        float LengthDelay = PlayAppreciationVoiceOver(Sound_Intro6[VOLanguage].clip.length+0.1f);
        ...
        TutorialObj2.transform.GetChild(1).GetComponent<PopTweenCustom>().Invoke("StopAnim", LengthDelay + 1f);
        PlayAudio(Sound_Intro7, LengthDelay+ Sound_Intro6[VOLanguage].clip.length + 2f);
        Invoke("SetGamePlay", Sound_Intro7[VOLanguage].clip.length +  5f);
    }
    #endregion
    ...
    void PlayQuestionVoiceOver(int _Qi)
    {
        switch (VOLanguage)
        {
            ...
            case 2:
                ...
                PlayAudioRepeated(Sound_QVO[_Qi].TL_Sound_QO[Random.Range(0,3)]);
                break;
        }
    }
   ...
   public float PlayAnswerVoiceOver(int Ai, float _delay)
    ...
    public AVO_AudioSource_C11031[] Sound_AVO;
    public QVO_AudioSource_C11031[] Sound_QVO;    
    ...
    [System.Serializable]
    public class AVO_AudioSource_C11031
    {
    ...
    [System.Serializable]
    public class QVO_AudioSource_C11031
    {
