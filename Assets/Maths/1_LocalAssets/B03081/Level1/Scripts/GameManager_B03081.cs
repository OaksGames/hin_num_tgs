...
public class GameManager_B03081 : MonoBehaviour, IOAKSGame
{
    ...
    {
        Tut_Items.transform.GetChild(6).gameObject.GetComponent<Text>().raycastTarget = true;
    }
    ...
    public void Selected_TutAnswer()
    {
        ...
        Tut_Items.transform.GetChild(6).GetComponent<Text>().raycastTarget = false;
        Tut_Items.transform.GetChild(6).GetComponent<PopTweenCustom>().StartAnim();
    ...
    public void BtnAct_OkTut()
    {
        ...
        Tut_Items.transform.GetChild(6).GetComponent<PopTweenCustom>().Invoke("StopAnim", LengthDelay + 1f);
    ...
    {
        RandAnsrIndex = Random.Range(0, (QuestionItems.Length-1));
    ...
    public void BtnAct_Ok()
    {
        ...
        else
        {
            ...
            if (WrongAnsrsCount >= 2)
            {
                ...
                float LengthDelay = PlayAnswerVoiceOver(RandQuestionOrder1, 1f);
    ...
    public QO_AudioSource_B03081 Sound_QVO;
    public AO_AudioSource_B03081 Sound_AVO;
...
[System.Serializable]
public class AO_AudioSource_B03081
{
...
[System.Serializable]
public class QO_AudioSource_B03081
{
