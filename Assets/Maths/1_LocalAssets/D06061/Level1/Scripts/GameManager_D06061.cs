...
public class GameManager_D06061 : MonoBehaviour, IOAKSGame
{
    public bool FrameworkOff = false;
    public bool Testing = false;

    public static GameManager_D06061 Instance;
    ...
    public void SetTutorial(GameInputData gameInputData)
    {
        ...
        Invoke("CallIntro2", Sound_Intro1[VOLanguage].clip.length + 1.2f);
    ...
    public void CallIntro3()
    {
        ...
        Invoke("Tut_ShovelEnable", Sound_Intro3[VOLanguage].clip.length + 0.2f);
    ...
    public void CallIntro7()
    {
        ...
        Tut_AnswerObjs[2].GetComponent<Text>().text = "" + 5;
        ...
        Invoke("EnableTutRaycast", Sound_Intro7[VOLanguage].clip.length);
    ...
    public IEnumerator Tut_ShovelTapAct()
    {
        ...
        if (_tempgemcount1 < Tut_Question)
        {
            ...
            float _delay = 0;
            for (int i = 0; i < Tut_EachCartMaxCount; i++)
            {
                iTween.MoveTo(Tut_CurrentGems[_tempgemcount1].gameObject, iTween.Hash("position", GemSlots[_slotCount].transform.position, "time", 0.25f, "delay", _delay, "easetype", iTween.EaseType.linear));
                yield return new WaitForSeconds(0.3f);
                Tut_CurrentGems[_tempgemcount1].transform.parent = Tut_GemSlots[_slotCount].transform.GetChild(0);
                _tempgemcount1++;
            }
            _slotCount++;
            if (_tempgemcount1 >= Tut_Question)
    ...
    public void BtnAct_OkTut()
    {
        ...
        Tut_EquationHolder.transform.GetChild(1).GetComponent<Text>().text = ""+4;
        ...
        iTween.ScaleTo(Tut_EquationHolder.transform.GetChild(0).gameObject, iTween.Hash("scale", new Vector3(1.25f, 1.25f, 1f), "time", 0.5f, "delay", LengthDelay + 1.75f, "easetype", iTween.EaseType.easeOutElastic));
        iTween.ScaleTo(Tut_EquationHolder.transform.GetChild(0).gameObject, iTween.Hash("scale", new Vector3(1f, 1f, 1f), "time", 0.5f, "delay", LengthDelay + 2f, "easetype", iTween.EaseType.easeOutElastic));
        iTween.ScaleTo(Tut_EquationHolder.transform.GetChild(1).gameObject, iTween.Hash("scale", new Vector3(1.25f, 1.25f, 1f), "time", 0.5f, "delay", LengthDelay + 2.5f, "easetype", iTween.EaseType.easeOutElastic));
        iTween.ScaleTo(Tut_EquationHolder.transform.GetChild(1).gameObject, iTween.Hash("scale", new Vector3(1f, 1f, 1f), "time", 0.5f, "delay", LengthDelay + 2.75f, "easetype", iTween.EaseType.easeOutElastic));
        iTween.ScaleTo(Tut_EquationHolder.transform.GetChild(2).gameObject, iTween.Hash("scale", new Vector3(1.25f, 1.25f, 1f), "time", 0.5f, "delay", LengthDelay + 3.25f, "easetype", iTween.EaseType.easeOutElastic));
        iTween.ScaleTo(Tut_EquationHolder.transform.GetChild(2).gameObject, iTween.Hash("scale", new Vector3(1f, 1f, 1f), "time", 0.5f, "delay", LengthDelay + 3.5f, "easetype", iTween.EaseType.easeOutElastic));
        PlayAudio(Sound_Intro9, LengthDelay + 0.2f);
        PlayAudio(Sound_CorrectAnswer, LengthDelay + Sound_Intro9[VOLanguage].clip.length+0.5f);
        Tween_TickMark.myScript.Invoke("Tween_In", LengthDelay + Sound_Intro9[VOLanguage].clip.length + 0.5f);
        PlayAudio(Sound_Intro10, LengthDelay + Sound_Intro9[VOLanguage].clip.length + 1f);
        Tut_OptionHolder.transform.GetChild(1).gameObject.GetComponent<PopTweenCustom>().Invoke("StopAnim", LengthDelay + 2f);
        Invoke("SetGamePlay", LengthDelay + Sound_Intro9[VOLanguage].clip.length + Sound_Intro10[VOLanguage].clip.length + 2f);
    ...
    public void GenerateLevel()
    {
        ...
        EquationHolder.transform.GetChild(1).GetComponent<Text>().text = "?";
    ...
    void PlayQuestionVO1(int _Qi)
    {
        switch (VOLanguage)
        {
            case 0:
                ...
                PlayAudio(Sound_QVO1.EN_Sound_QO[_Qi],0);
                break;
            case 1:
                QVOLength = Sound_QVO1.HI_Sound_QO[_Qi].clip.length;
                PlayAudio(Sound_QVO1.HI_Sound_QO[_Qi],0);
                break;
            case 2:
                QVOLength = Sound_QVO1.TL_Sound_QO[_Qi].clip.length;
                PlayAudio(Sound_QVO1.TL_Sound_QO[_Qi],0);
                break;
        }
    ...
    {
        PlayQuestionVO2(CurrentQuestion2-2);
    ...
    public void BtnAct_Ok()
    {
        ...
        else
        {
            ...
            if (WrongAnsrsCount >= 2)
            {
                ...
                LengthDelay = PlayAnswerVoiceOver1(CurrentQuestionOrder, 1f);
                EquationHolder.transform.GetChild(1).gameObject.SetActive(true);
                EquationHolder.transform.GetChild(1).GetComponent<Text>().text = "" + CurrentQuestion2;
                EquationHolder.transform.GetChild(2).gameObject.SetActive(true);
                iTween.ScaleFrom(EquationHolder.transform.GetChild(2).gameObject, iTween.Hash("scale", Vector3.zero, "time", 0.5f, "delay", 0, "easetype", iTween.EaseType.easeOutElastic));
    ...
    {
        Is_CannTapShovel = false;
        PlayAudio(Sound_Selection, 0);
        yield return new WaitForSeconds(0);
        Debug.Log("ShovelTapAct");
        if (_tempgemcount < CurrentQuestion)
        {
            _tempGem = CurrentGems[_tempgemcount];

            float _delay = 0;
            for (int i =0; i < EachCartMaxCount; i++)
            {               
                iTween.MoveTo(CurrentGems[_tempgemcount].gameObject, iTween.Hash("position", GemSlots[_slotCount].transform.position, "time", 0.25f, "delay", _delay, "easetype", iTween.EaseType.linear));
                yield return new WaitForSeconds(0.3f);
                CurrentGems[_tempgemcount].transform.parent = GemSlots[_slotCount].transform.GetChild(0);
                _tempgemcount++;
            }            
            _slotCount++;
            if (_tempgemcount >= CurrentQuestion)
            {
                ...
                iTween.MoveTo(SidePanel.gameObject, iTween.Hash("x", 512, "islocal", true, "time", 0.25f, "delay", 0, "easetype", iTween.EaseType.easeOutElastic));
                _tempQopt = CurrentQuestion2;
                StartCoroutine("SetAnswerOptions", 0);
            }
    ...
    public QVO_AudioSource_D06061 Sound_QVO1;
    public QVO_AudioSource_D06061 Sound_QVO2;
    public QVO_AudioSource_D06061 Sound_QVO3;
  
    public AVO_AudioSource_D06061 Sound_AVO1;
    ...
    [System.Serializable]
    public class AVO_AudioSource_D06061
    {
    ...
    [System.Serializable]
    public class QVO_AudioSource_D06061
    {
