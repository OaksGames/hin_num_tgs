...
[System.Serializable]
public class QuestionSpriteItems_C11012
{
    public Sprite[] QuestonSprites;
}

public class GameManager_C11012 : MonoBehaviour, IOAKSGame
{
    ...
    public GameObject Tut_QuestionItems1;
    public GameObject Tut_QuestionItems2;
    ...
    //public QuestionSpriteItems_C11012[] QuestionItems;
    void Start()
    {
    ...
    public void SetTutorial(GameInputData gameInputData)
    {
        ...
        Invoke("CallIntro2", Sound_Intro1[VOLanguage].clip.length + Sound_Intro2[VOLanguage].clip.length + 3f);
        Invoke("EnableAnimator", 2);
        Invoke("EnableTutNoTRaycatTarget", Sound_Intro1[VOLanguage].clip.length + Sound_Intro2[VOLanguage].clip.length+6f);
    }
    ...
    {
        Tut_QuestionItems2.transform.GetChild(1).GetComponent<Image>().raycastTarget = true;
    }

    public void CallIntro2()
    {
        Tut_QuestionItems1.SetActive(false);
        Tut_QuestionItems2.SetActive(true);
    ...
    public void Selected_TutAnswer()
    {
        ...
        Tut_QuestionItems2.transform.GetChild(1).GetComponent<Image>().raycastTarget = false;
        Tut_QuestionItems2.transform.GetChild(1).GetComponent<PopTweenCustom>().StartAnim();
    ...
    public void BtnAct_OkTut()
    {
        ...
        Invoke("SetGamePlay", LengthDelay + Sound_Intro5[VOLanguage].clip.length+Sound_Intro5[VOLanguage].clip.length + 1.5f);
    }
    #endregion
    ...
    public AVO_AudioSource_C11012 Sound_AVO;
    public QVO_AudioSource_C11012[] Sound_QVO;
    ...
    [System.Serializable]
    public class AVO_AudioSource_C11012
    {
    ...
    [System.Serializable]
    public class QVO_AudioSource_C11012
    {
