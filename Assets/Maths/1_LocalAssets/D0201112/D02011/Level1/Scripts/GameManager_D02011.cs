...
public class GameManager_D02011 : MonoBehaviour, IOAKSGame
{
    ...
    public void SetTutorial(GameInputData gameInputData)
    {
        ...
        PlayAudio(Sound_Intro3, Sound_Intro1[VOLanguage].clip.length+Sound_Intro2[VOLanguage].clip.length + 3f);
        PlayAudio(Sound_Intro4, Sound_Intro1[VOLanguage].clip.length + Sound_Intro2[VOLanguage].clip.length +Sound_Intro3[VOLanguage].clip.length + 3f);
        ...
        Invoke("CallIntro3", Sound_Intro1[VOLanguage].clip.length + Sound_Intro2[VOLanguage].clip.length + Sound_Intro3[VOLanguage].clip.length + Sound_Intro4[VOLanguage].clip.length + 2f);
    }
    ...
    public void BtnAct_OkTut()
    {
        ...
        Invoke("SetGamePlay", LengthDelay + LengthDelay2 + Sound_Intro7[VOLanguage].clip.length + 2.5f);
    }
    #endregion
    ...
    public void GenerateLevel()
    {
        ...
        for (int i = 0; i < AnswerObjs.Length; i++)
        {
            if (RandAnsrIndex == i)
            {
                ...
                QuestionOrderListtemp.Remove(CurrentQuestion);
            }
            else
            {
                if (i == 0)
    ...
    {
         Is_CanClick = false;
        iTween.RotateTo(Obj_Hours.gameObject, iTween.Hash("z", ((-30 * _TimeInput)-15), "time", 1f, "delay", 0f, "easetype", iTween.EaseType.easeOutCirc));

        iTween.ValueTo(this.gameObject, iTween.Hash("from", Obj_Minutes.transform.localEulerAngles.z, "to", -180, "time", 1f, "delay", 0, "easetype", iTween.EaseType.linear,
