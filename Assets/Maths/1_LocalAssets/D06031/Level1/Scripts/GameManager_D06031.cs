...
public class GameManager_D06031 : MonoBehaviour, IOAKSGame
{
    public bool FrameworkOff = false;
    public bool Testing = false;

    public static GameManager_D06031 Instance;
    ...
    public void BtnAct_OkTut()
    {
        ...
        PlayAudio(Sound_Intro8, LengthDelay + 0.2f);
        PlayAudio(Sound_CorrectAnswer, LengthDelay + Sound_Intro8[VOLanguage].clip.length + 0.2f);
        Tween_TickMark.myScript.Invoke("Tween_In", LengthDelay + Sound_Intro8[VOLanguage].clip.length+0.2f);
        PlayAudio(Sound_Intro9, LengthDelay + Sound_Intro8[VOLanguage].clip.length + 0.5f);
        Tut_OptionHolder.transform.GetChild(1).gameObject.GetComponent<PopTweenCustom>().Invoke("StopAnim", LengthDelay + 2f);
        Invoke("SetGamePlay", LengthDelay + Sound_Intro9[VOLanguage].clip.length + Sound_Intro8[VOLanguage].clip.length + 2f);
    ...
    public IEnumerator SetAnswerOptions(float _delay)
    {
        ...
        QuestionOrderListtemp.Remove(EachCartMaxCount);
        float _delay1 = 0;
        for (int i = 0; i < AnswerObjs.Length; i++)
        {
            if (RandAnsrIndex == i)
            {
                AnswerObjs[i].GetComponent<Text>().text = "" + EachCartMaxCount;
    ...
    public void BtnAct_Ok()
    {
        ...
        if (CorrectAnsrIndex == UserAnsr)
        {
            ...
            EquationHolder.transform.GetChild(2).gameObject.SetActive(true);
                ...
                float LengthDelay2 = PlayAnswerVoiceOver1(EachCartMaxCount - 1, LengthDelay + 0.5f);
        ...
        else
        {
            ...
            {
                LengthDelay = PlayAnswerVoiceOver1(EachCartMaxCount-1, 1f);
                EquationHolder.transform.GetChild(2).gameObject.SetActive(true);
                iTween.ScaleFrom(EquationHolder.transform.GetChild(2).gameObject, iTween.Hash("scale", Vector3.zero, "time", 0.5f, "delay", 0, "easetype", iTween.EaseType.easeOutElastic));
    ...
    public QVO_AudioSource_D06031 Sound_QVO1;
    public QVO_AudioSource_D06031 Sound_QVO2;
    public QVO_AudioSource_D06031 Sound_QVO3;
   
    public AVO_AudioSource_D06031 Sound_AVO1;
    ...
    IEnumerator PlayAudioRepeatedCall()
    {
        ...
        if (!Is_OkButtonPressed)
        {
            ...
            yield return new WaitForSeconds(7f + 7f);
            StartCoroutine("PlayAudioRepeatedCall");
        }
    }
    ...
    [System.Serializable]
    public class AVO_AudioSource_D06031
    {
    ...
    [System.Serializable]
    public class QVO_AudioSource_D06031
    {
